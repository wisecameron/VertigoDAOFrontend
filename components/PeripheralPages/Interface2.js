...
export function Interface2()
{
    ...
    */
    ...
    var ProfileDisconnectedDashboard = ProfileDisconnected(profileConnected, web3Connected, false) //2
    var ProfileConnectedDashboard = ProfileConnected(profileConnected, profileId, address, profileData[7], profileData) //3
    ...
    console.log(Dashboard, ProfileDisconnectedDashboard, ProfileConnectedDashboard)
    ...
    return(
                ...
                <Row style = {{height: "0.0005vmax", background: "red", marginTop: "-4vmax"}}>
